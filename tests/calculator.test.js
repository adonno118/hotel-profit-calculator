...
assert.equal(simple.details.payrollBurden, 735000, '정규 청소인력 급여에만 사업주 부담률 적용');
...
assert.equal(monthlySimple.details.payrollBurden, 0, '달방 청소비에는 정규인력 보험 부담률 미적용');
...
assert.equal(hybridSimple.details.payrollBurden, 367500, '혼합형 정규 청소인력 급여에만 보험 부담률 적용');
