export const SITE_CONFIG = {
  name: '숙박업 수익률 계산기',
  siteUrl: 'https://hotel-profit-calculator.cobus836.workers.dev',
  locale: 'ko_KR',
  ...
  pages: {
    ...
    '/about.html': { title: '사이트 소개 | 숙박업 수익률 계산기', description: '숙박업 매물 검토를 돕는 참고용 손익 계산 서비스의 목적과 원칙을 안내합니다.' },
    '/guide.html': { title: '이용 가이드 | 숙박업 수익률 계산기', description: '객실 수, 매출, 고정비·변동비, 공과금과 투자비를 입력하고 숙박업 손익 결과를 해석하는 방법입니다.' },
    '/privacy.html': { title: '개인정보처리방침 | 숙박업 수익률 계산기', description: '브라우저 저장소, 쿠키, 광고 서비스와 개인정보 처리 원칙을 안내합니다.' },
    '/disclaimer.html': { title: '면책 안내 | 숙박업 수익률 계산기', description: '숙박업 손익 추정 결과의 범위와 투자 전 확인해야 할 사항을 안내합니다.' },
    '/contact.html': { title: '문의 안내 | 숙박업 수익률 계산기', description: '서비스 이용, 오류 제보, 개인정보 관련 문의 방법을 안내합니다.' }
  }
};
