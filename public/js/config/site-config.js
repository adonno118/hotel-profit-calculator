export const SITE_CONFIG = {
  ...
  pages: {
    ...
    '/about': { title: '사이트 소개 | 숙박업 수익률 계산기', description: '숙박업·고시원 운영 경험을 바탕으로 만든 무료 숙박업 매물 수익성 계산 도구의 목적과 원칙을 안내합니다.' },
    '/guide': { title: '숙박업 수익성 가이드 | 매출·운영비·수익률 이해', description: '객실 수, 월매출, 운영비, 청소 인건비와 투자 수익률을 이해하고 숙박업 손익을 검토하는 실무형 가이드입니다.' },
    '/privacy': { title: '개인정보처리방침 | 숙박업 수익률 계산기', description: '브라우저 저장소, 쿠키, 광고 서비스와 개인정보 처리 원칙을 안내합니다.' },
    '/terms': { title: '이용약관 | 숙박업 수익률 계산기', description: '숙박업 수익 계산기 이용 조건, 결과의 한계와 사용자의 책임을 안내합니다.' },
    '/disclaimer': { title: '면책 안내 | 숙박업 수익률 계산기', description: '숙박업 손익 추정과 보증금·권리금·회수기간 해석의 범위, 계약 전 확인 사항을 안내합니다.' },
    '/contact': { title: '문의 안내 | 숙박업 수익률 계산기', description: '계산 오류, 계산 기준 제안과 사이트 개선 의견을 보내는 방법을 안내합니다.' }
  }
};
